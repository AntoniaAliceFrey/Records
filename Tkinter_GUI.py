...
class Gui(DbAccess):
    ...
    def get_tb_data(self):
        '''
        This function reads the content in the textboxes and returns a list with the contact data.
        The function is called when a new record is added to the database and for searching records in the db.
        '''
    ...
    def make_window(self):
        ...
        self.search_btn = Button(self.data_frame, text="Search Records", 
                                 command=lambda: [self.viewer.make_window(self.get_tb_data()),
                                                  self.clear_textboxes])
